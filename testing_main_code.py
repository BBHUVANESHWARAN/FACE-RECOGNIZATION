...
fps = FPS().start()
dictionary={"Name":[],'Date':[],"Time":[]}


name_list=['arun','ananth']
...
while True:
    ...
    with open ('details.txt','a') as file:
        ...
        if key == ord("q"):
            ...
            if name in name_list and area > 58800:
                ...
                dictionary['Time'].append(time.split('.')[0])
...
output.to_csv('Final_output_Details.csv')
