...
datasets = 'datasets'  #All the faces data will be present this folder
sub_data = 'Bhuvanesh'     #These are sub data sets of folder, for my faces I've used my name
...
##while True:
    ...
    (_, im) = webcam.read()
    rect = cv2.rectangle(im,(250,50),(500,300),(0,255,0),6)

##    cv2.imwrite('%s/%s.png' % (path,count), im) 
    
    cv2.imwrite(path+'/'+str(count)+'.jpg',im)
