...
myquery = { "card_number": card_number }

finding_card_number=my_collection.find_one(myquery)
...
while True:
    ...
    if key == ord("q"):
        ...
        myquery = { "card_number": card_number }
        finding_user_number=my_collection.find_one(myquery)
        finding_name=finding_user_number['Name']
        user_name=text.split(':')[0]
        
        if finding_name==user_name:
            print('welcome',user_name)
            break
        else:
            print('Sry unknown member')
